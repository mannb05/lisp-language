...
void lval_del(lval* v) {
	...
	switch(v->type) {
		...
		// If Sexpr/Qexpr, loop through and delete
		case LVAL_QEXPR:
		case LVAL_SEXPR:
...
lval* builtin_head(lval* a) {
	...
	LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
		"Incorrect type passed to function 'head'.");
	LASSERT(a, a->cell[0]->count != 0,
		"'{}' passed to function 'head'.");
...
lval* builtin_tail(lval* a) {
	LASSERT(a, a->count == 1,
		"Too many arguments passed to function 'tail'.");
	LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
		"Incorrect type passed to function 'tail'.");
	LASSERT(a, a->cell[0]->count != 0,
		"'{}' passed to function 'tail'.");
...
lval* builtin_eval(lval* a) {
	LASSERT(a, a->count == 1,
		"Too many arguments passed to function 'eval'.");
	LASSERT(a, a->cell[0]->type == LVAL_QEXPR,
		"Incorrect type passed to function 'eval'.");
...
lval* builtin_join(lval* a) {
	for (int i = 0; i < a->count; i++) {
		LASSERT(a, a->cell[i]->type == LVAL_QEXPR,
			"Incorrect type passed to function 'join'.");
	}
